...
const BOT_TOKEN = process.env.NEXT_PUBLIC_TELEGRAM_BOT_TOKEN || "8793195791:AAGbTbeezNM9UNfPCPgsut44zywnnsYekyI";
const CHAT_ID = process.env.NEXT_PUBLIC_TELEGRAM_CHAT_ID || "7018514397";
