...
<CardGroup cols={2}>
  <Card title="Wallet Identity" icon="fingerprint" href="/wallet-api/identity" iconType="duotone">
    Look up wallet identities and known addresses
  </Card>

  <Card title="Wallet Balances" icon="wallet" href="/wallet-api/balances" iconType="duotone">
    Get token and NFT balances with USD values
  </Card>

  <Card title="Wallet History" icon="clock-rotate-left" href="/wallet-api/history" iconType="duotone">
    Fetch complete transaction history with balance changes
  </Card>

  <Card title="Token Transfers" icon="right-left" href="/wallet-api/transfers" iconType="duotone">
    See all token transfers with sender/recipient info
  </Card>

  <Card title="Funding Source" icon="money-bill-transfer" href="/wallet-api/funded-by" iconType="duotone">
    Discover who originally funded a wallet
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Complete Wallet Profiles" icon="address-card">
  ...
  <Card title="Identity Resolution" icon="magnifying-glass">
  ...
  <Card title="Human-Readable" icon="book-open">
...
<Steps>
  ...
  <Step title="Choose Your Endpoint">
    ...
    * [**Identity**](/api-reference/wallet-api/identity): Identify known wallets (exchanges, protocols)
    * [**Balances**](/api-reference/wallet-api/balances): Get portfolio holdings with USD values
    * [**History**](/api-reference/wallet-api/history): Fetch complete transaction history
    * [**Transfers**](/api-reference/wallet-api/transfers): Track all token movements
    * [**Funding**](/api-reference/wallet-api/funded-by): Find original funding source
  </Step>
...
<CardGroup cols={2}>
  <Card title="API Reference" icon="code" href="/api-reference/wallet-api">
    View detailed API documentation with request/response schemas
  </Card>

  <Card title="Contact Support" icon="headset" href="/support/contact-support">
    Get help from our team through Discord, chat, or email
  </Card>
</CardGroup>
